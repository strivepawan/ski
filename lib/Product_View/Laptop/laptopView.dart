  ...
  Widget _buildProductRow(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
          child: ProductCard(
            imagePath: 'assets/images/laptop1.avif',
            productAbout: '2022 MacBook Pro',
            price: '\$1999',
            location: 'San Francisco, CA',
            postDate: 'Posted: March 28th, 2024',
            maxWidth: maxWidth,
          ),
        ),
        ...
        Expanded(
          child: ProductCard(
            imagePath: 'assets/images/laptop1.avif',
            productAbout: '2023 Dell XPS 15',
            price: '\$1799',
            location: 'Austin, TX',
            postDate: 'Posted: March 30th, 2024',
            maxWidth: maxWidth,
          ),
        ),
      ],
