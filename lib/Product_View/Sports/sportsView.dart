  ...
  Widget _buildProductRow(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
          child: ProductCard(
            imagePath: 'assets/images/sports2.jpeg',
            productAbout: 'Nike Air Zoom Pegasus 38',
            price: '\$120',
        ...
        Expanded(
          child: ProductCard(
            imagePath: 'assets/images/sports2.jpeg',
            productAbout: 'Adidas Ultraboost 21',
            price: '\$180',
            location: 'Herzogenaurach ',
            postDate: 'Posted: April 12th, 2024',
            maxWidth: maxWidth,
          ),
        ),
      ],
