  ...
  Widget _buildProductRow(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
          child: ProductCard(
            imagePath: 'assets/images/furniture1.jpg',
            productAbout: 'Modern Sofa Set',
            price: '\$899',
            location: 'New York, USA',
            postDate: 'Posted: April 8th, 2024',
            maxWidth: maxWidth,
          ),
        ),
        ...
        Expanded(
          child: ProductCard(
            imagePath: 'assets/images/furniture1.jpg',
            productAbout: 'Antique Wooden Table',
            price: '\$599',
            location: 'London, UK',
            postDate: 'Posted: April 11th, 2024',
            maxWidth: maxWidth,
          ),
        ),
      ],
